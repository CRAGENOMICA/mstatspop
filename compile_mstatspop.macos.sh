...
#To compile:
#gcc ./mstatspop/*.c -lm -o ./bin/mstatspop -Wall -O3 -lz
...
#gcc ./mstatspop/*.c -lgsl -lgslcblas -lm -o ./bin/mstatspop -Wall -DinGSL=1 -O3 -lz 
#or
#gcc ./mstatspop/*.c -lgsl -lgslcblas -lm -o ./bin/mstatspop -Wall -DinGSL=1 -O3 -lz -L/opt/homebrew/Cellar/gsl/2.8/lib/ /opt/homebrew/Cellar/gsl/2.8/lib/libgsl.a -I/opt/homebrew/Cellar/gsl/2.8/include
#for linux:
#gcc ./mstatspop/*.c -lgsl -lgslcblas -lm -o ./bin/mstatspop -Wall -DinGSL=1 -O3 -lz
